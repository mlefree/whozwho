...
exports.AdviceStatics = {
    ...
    async _createAdvice(fromActor, toActorId, toActorCategory, type, status) {
        const advice = new exports.AdviceModel({
            type,
            fromActor,
            toActorId,
            toActorCategory,
    ...
    async AskToUpdate(fromActorCategory, fromActorId, toCategory) {
        ...
        for (const actorCategory of actorCategories) {
            ...
            const advice = await this._createAdvice(fromActor, toActorId, toActorCategory, AdviceType.UPDATE, AdviceStatus.TODO);
            advices.push(advice);
        }
        return advices;
    },
